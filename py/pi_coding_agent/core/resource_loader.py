"""Resource loader for pi_coding_agent.
...
from pi_coding_agent.core.extensions.types import LoadExtensionsResult
...
def _create_empty_runtime() -> Any:
    ...
    from pi_coding_agent.core.extensions.types import ExtensionRuntime
