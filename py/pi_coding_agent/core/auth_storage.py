...
from pi_ai import get_env_api_key, get_oauth_api_key, get_oauth_provider, get_oauth_providers
from pi_ai.oauth.types import OAuthCredentials, OAuthLoginCallbacks
...
def _oauth_creds_from_oauth_credential(cred: OAuthCredential) -> OAuthCredentials:
    ...
    from pi_ai.oauth.types import OAuthCredentials
