"""List selection component with filtering and scrolling."""
...
class SelectListTheme:
    """Styling functions for SelectList rendering."""
...
class SelectList:
    """Scrollable list for selecting an item.

    Supports filtering, wrapping navigation, and callbacks for
    selection, cancellation, and selection changes.
    """
    ...
    def render(self, width: int) -> list[str]:
        ...
        for i in range(start_index, end_index):
            ...
            if is_selected:
                prefix_width = 2  # visual width of arrow + space
                if desc_single and width > 40:
                    ...
                    if remaining_width > 10:
                        truncated_desc = truncate_to_width(desc_single, remaining_width, "")
