"""Text component with word wrapping, padding, and optional background."""
...
class Text:
    ...
    Supports horizontal/vertical padding and an optional background color
    function that is applied to every line (including padding).
    """
